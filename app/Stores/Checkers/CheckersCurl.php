...
class CheckersCurl extends CurlStore implements StoreCurlInterface
{
    ...
    public function fetchProduct($item)
    {
        ...
        $url = "https://www.checkers.co.za/search/all?q={$item[$this->storeSlug]['exact-item-names']}";
        $this->curlStore($url);
        $this->saveHtml();
    }
    ...
    public function findProductPrice($item)
    {
        ...
        try {
            ...
            $this->noProduct($item['common-name']);
        }
    }
}
